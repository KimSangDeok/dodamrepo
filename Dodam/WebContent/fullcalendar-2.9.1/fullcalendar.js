...
var DayGrid = FC.DayGrid = Grid.extend(DayTableMixin, {
	...
	renderNumberCellHtml: function(date) {
		...
		return '' +
			"<td class='" + classes.join(' ') + " tooltipstered' data-date='" + date.format() 
			+ "' title='"+"와우!!더블클릭하여 예약하기!'"
			+"style='cursor:zoom-in'"
			+"onclick='javascript:todayclick(this)'"
			+"ondblclick='todaydoubleclick(this)'"
			+"onmouseover='over(this)'"
			+">" 
			+date.date() +"</td>";
//		"<span class='tooltip' title='와우!!더블클릭하여 예약하기!' style='cursor:zoom-in'>툴팁이켜지는 부분</span>"
	},
