...
/* 		#footer .inner {display: inline;} */
		#footer .inner .content{ margin-right:600px;}
		#footer .inner .copyright{margin-right:600px;}
	</style>
    ...
    .panel-primary {border-color: #e74c3c;}
    ...
    .panel-footer li a {color:#e74c3c; }  
    .panel panel-primary{float:left;    }
    .pagination{ width: 650px;}
...
<!-- 	<div class="jquery-script-clear"></div>
 -->	
		<div class="row" style="float:right">
			<div id="firstTable" class="col-sm-6 col-sm-offset-3">
			</div>
...
<script type="text/javascript" src="/calendar-js/paginathing.js"></script>
		<script type="text/javascript">
			jQuery(document).ready(function($){
				for (var i = 1; i <= 150; i++) {
					$('.list-group').append('<li class="list-group-item"> 접수자 ' + i + '</li>');
				}
