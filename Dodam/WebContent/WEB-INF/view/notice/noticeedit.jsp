...
<script type="text/javascript">
	...
	$(function() {
		nhn.husky.EZCreator.createInIFrame({
			...
			fOnAppLoad : function() {
				var contents = '${model.notice_content}';
				//기존 저장된 내용의 text 내용을 에디터상에 뿌려주고자 할때 사용
				oEditors.getById["notice_content"].exec("PASTE_HTML",[contents]);
			},
		...
		$("#edit").click(
				function() {
					oEditors.getById["notice_content"]
	...
	<div class="contentwrap">
		<article class="container">
			...
			<div class="container notice">
				...
				<form id="writefrm" name="update" method="post"
					action="edit_ok.dodam">
					<table class="table">
					...
					<hr />
					<input type="button" class="btn btn-default pull-right" value="뒤로" onclick="history.back()" />
					<input type="button" id="edit" class="btn btn-default pull-right" value="수정" />
